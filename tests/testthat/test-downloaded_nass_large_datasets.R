test_that("downloaded_nass_large_datasets caches without network", {
  ...
  # extra guard: some old xml2 builds might miss read_html()
  ...
  # --- mocks (bind to the owner environments) ---
  ...
  # IMPORTANT: download.file is imported into your package namespace,
  # so mock it in *your* package env, not utils
  pkg_ns <- asNamespace("arpcPriceBasis")
