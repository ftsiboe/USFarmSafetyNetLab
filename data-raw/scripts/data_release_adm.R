...
# recodes practice
rm(list= ls()[!(ls() %in% c(Keep.List))])
source(paste0("data-raw/scripts/data_release_adm_recodes_practice.R"))
...
# recodes palns
rm(list= ls()[!(ls() %in% c(Keep.List))])
source(paste0("data-raw/scripts/data_release_adm_recodes_palns.R"))
...
# recodes commodity
rm(list= ls()[!(ls() %in% c(Keep.List))])
source(paste0("data-raw/scripts/data_release_adm_recodes_commodity.R"))
...
# commodity price
rm(list= ls()[!(ls() %in% c(Keep.List))])
source(paste0("data-raw/scripts/data_release_adm_commodity_price.R"))
...
# base rate
rm(list= ls()[!(ls() %in% c(Keep.List))])
source(paste0("data-raw/scripts/data_release_adm_base_rate.R"))
