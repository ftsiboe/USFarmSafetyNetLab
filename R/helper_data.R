...
#' @name ice_ao_expense_subsidy_percent
#' @title ice_ao_expense_subsidy_percent
#' @description A combined dataset for ice_ao_expense_subsidy_percent
#' @format A data frame with 4232 rows and 7 columns covering 1998-2025.
#' @source USDA-RMA, Insurance Control Elements - PASS - D00154
#' @usage data(ice_ao_expense_subsidy_percent)
...
#' @format A data frame with 913 rows and 15 columns covering Inf--Inf.
#' @source USDA-RMA, Insurance Control Elements - PASS - D00154
...
"agCensusBFR"
#' @name agCensusInsurance
#' @title agCensusInsurance
#' @description A combined dataset for agCensusInsurance
#' @format A data frame with 329783 rows and 10 columns covering Inf--Inf.
#' @source USDA NASS Quick Stats
#' @usage data(agCensusInsurance)
"agCensusInsurance"
...
#' @name nassSurveyAnimalInventory
#' @title nassSurveyAnimalInventory
#' @description A combined dataset for nassSurveyAnimalInventory
#' @format A data frame with 175547 rows and 10 columns covering 1920-2025.
#' @source USDA NASS Quick Stats - Animal inventory as of first of Jan
#' @usage data(nassSurveyAnimalInventory)
...
#' @name fcip_aph_base_rate
#' @title fcip_aph_base_rate
#' @description A combined dataset for fcip_aph_base_rate
#' @format A data frame with 428502 rows and 6 columns covering 2001-2026.
#' @source USDA-RMA, Actuarial Data Master supplemented data from legacy ADM files
#' @usage data(fcip_aph_base_rate)
"fcip_aph_base_rate"
#' @name fcip_contiguous_county
#' @title fcip_contiguous_county
#' @description A combined dataset for fcip_contiguous_county
#' @format A data frame with 24307 rows and 12 columns covering Inf--Inf.
#' @source USDA-RMA, Actuarial Data Master - A0123
#' @usage data(fcip_contiguous_county)
...
#' @format A data frame with 3572 rows and 10 columns covering 1997-2025.
...
#' @format A data frame with 773 rows and 10 columns covering 1989-2025.
